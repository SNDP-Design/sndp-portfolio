(function() {
    ...
    function injectTLDRBoxes() {
        ...
        box.style.cssText = 'background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.15);border-radius:20px;padding:24px 28px;margin:32px auto 48px auto;width:100%;max-width:900px;backdrop-filter:blur(12px);font-family:Inter,sans-serif;box-sizing:border-box;text-align:left;';

        var titleHeader = '<div style="display:flex;align-items:center;gap:8px;margin-bottom:16px;"><span style="display:inline-block;width:8px;height:8px;border-radius:50%;background-color:#ffffff;box-shadow:0 0 8px rgba(255,255,255,0.6);"></span><h4 style="color:#ffffff;font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px;margin:0;">Executive Summary & ROI</h4></div>';

        if (path.includes('/clix')) {
            box.innerHTML = titleHeader + '<div class="tldr-grid"><div style="background:rgba(0,0,0,0.4);padding:16px;border-radius:14px;border:1px solid rgba(255,255,255,0.08);"><div style="color:#a0a0a0;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:0.5px;margin-bottom:6px;">My Role</div><div style="color:#ffffff;font-size:14px;font-weight:600;">Lead Product / UX Designer</div></div><div style="background:rgba(0,0,0,0.4);padding:16px;border-radius:14px;border:1px solid rgba(255,255,255,0.08);"><div style="color:#a0a0a0;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:0.5px;margin-bottom:6px;">Scope & Platform</div><div style="color:#ffffff;font-size:14px;font-weight:600;">B2B Web App & Analytics</div></div><div style="background:rgba(0,0,0,0.4);padding:16px;border-radius:14px;border:1px solid rgba(255,255,255,0.08);"><div style="color:#a0a0a0;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:0.5px;margin-bottom:6px;">Key Metric Impact</div><div style="color:#ffffff;font-size:14px;font-weight:700;">+45% Setup Speed & Efficiency</div></div></div>';
            h1.after(box);
        } else if (path.includes('/fatca-crs')) {
            box.innerHTML = titleHeader + '<div class="tldr-grid"><div style="background:rgba(0,0,0,0.4);padding:16px;border-radius:14px;border:1px solid rgba(255,255,255,0.08);"><div style="color:#a0a0a0;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:0.5px;margin-bottom:6px;">My Role</div><div style="color:#ffffff;font-size:14px;font-weight:600;">Senior Product Designer (Tide)</div></div><div style="background:rgba(0,0,0,0.4);padding:16px;border-radius:14px;border:1px solid rgba(255,255,255,0.08);"><div style="color:#a0a0a0;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:0.5px;margin-bottom:6px;">Scope & Platform</div><div style="color:#ffffff;font-size:14px;font-weight:600;">iOS / Android Mobile App</div></div><div style="background:rgba(0,0,0,0.4);padding:16px;border-radius:14px;border:1px solid rgba(255,255,255,0.08);"><div style="color:#a0a0a0;font-size:11px;text-transform:uppercase;font-weight:700;letter-spacing:0.5px;margin-bottom:6px;">Key Metric Impact</div><div style="color:#ffffff;font-size:14px;font-weight:700;">-65% Onboarding Drop-off</div></div></div>';
            h1.after(box);
